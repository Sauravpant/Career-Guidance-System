...
export const getWeeklyGoals = asyncHandler(

  async (req: AuthenticatedRequest, res: Response) => {

    const userId = req.user.id;
    const { date } = req.query;
    const goals = await weeklyGoalService.getWeeklyGoals(
      userId,
...
export const createWeeklyGoal = asyncHandler(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    const goal = await weeklyGoalService.createWeeklyGoal(
      userId,
      title,
...
export const updateWeeklyGoal = asyncHandler(
...
export const deleteWeeklyGoal = asyncHandler(
