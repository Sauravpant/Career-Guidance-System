...
def build_feature_matrix(
    ...
    X = np.hstack([X_edu, X_skills, X_interests])
    return X, skill_mlb, interest_mlb, edu_encoder


def encode_target(series: pd.Series, le: LabelEncoder = None, fit: bool = True):
    if fit:
        le = LabelEncoder()
